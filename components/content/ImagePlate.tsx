    ...
    >
      ...
      {caption ? (
        <div className="absolute bottom-0 right-0 bg-[var(--scrim-plate)] px-3 py-2">
          <div className="whitespace-pre-line font-text text-label uppercase tracking-[0.1em] text-paper-100">
            {caption}
          </div>
          {captionRole ? (
            <div className="font-text text-label-sm font-bold uppercase tracking-label text-yellow-400">
              {captionRole}
            </div>
          ) : null}
        </div>

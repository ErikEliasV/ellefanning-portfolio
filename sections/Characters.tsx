        ...
        <div className="min-w-0 flex-1">
          <div className="bleed py-8">
            <SectionHeader
              ...
              title="Characters"
              tone="invert"
              lead="Not the films — the people inside them. Hover a face to read what she made of it."
            />
          </div>
            ...
            {CHARACTERS.map((character, index) => (
              ...
              >
                ...
                <div className="pointer-events-none absolute inset-x-0 bottom-0 flex flex-col gap-1 bg-[var(--scrim-plate)] px-3 py-2">
                  <span className="font-mono text-micro font-bold uppercase tracking-label text-yellow-400">
